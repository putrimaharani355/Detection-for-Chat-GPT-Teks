# -*- coding: utf-8 -*-
"""Skripsi (Optimizer Adam)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13cEHnXGZAZqToRqrF9XTYfrMVcFonTsP
...
# Optimizer
optimizer = tf.keras.optimizers.AdamW(learning_rate=3e-5, weight_decay=0.02)

# Model
model = TFBertForSequenceClassification.from_pretrained('bert-base-uncased', num_labels=2)
model.dropout = tf.keras.layers.Dropout(0.2)
